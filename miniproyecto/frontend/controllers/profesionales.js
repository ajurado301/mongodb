...
//***************************************************************************
// Fin Restablecer formulario y tabla de resultados
//***************************************************************************
...
function profesionalAFormulario(profesional){
    let { name, age, genre, weight, height, hairColor, eyeColor, race, isRetired, nationality, oscarsNumber, profession, url_foto } = profesional;
    ...
    if (url_foto) {$('#url-profesional').val(url_foto)};
}
//***************************************************************************
// Fin Mostrar profesional en formulario
//***************************************************************************
...
function profesionalAListado(profesionales) {
    ...
    profesionales.forEach((profesional) => {
        let { _id, name, age, genre, weight, height, hairColor, eyeColor, race, isRetired, nationality, oscarsNumber, profession, url_foto } = profesional;
        if (!url_foto) { url_foto = './img/nofoto.png' }
        let item = '';
        ...
        item += `<img src="${url_foto}" class="rounded" style="width: 100px; height: 150px" alt="Foto profesional"></div>`;
...
//***************************************************************************
// Fin Mostrar Listado de profesionales en la tabla
//***************************************************************************
...
//***************************************************************************
// Fin Seleccionar profesional de la lista mostrada yrellenar form
//***************************************************************************
...
function leerFormularioProfesional() {
    ...
    input = $('#url-profesional').val().trim();
    if (input) { result.url_foto = input; $('#url-profesional').val(input) };    
    return result;
}
//***************************************************************************
// Leer formulario profesional
