...
function peliculaAFormulario(pelicula){
    let{ title, releaseYear, nationality, language, platform, isMCU, mainCharacterName, distributor, genre, producer, actors, directors, writers, url_foto } = pelicula;
    ...
    if (url_foto) {$('#url-pelicula').val(url_foto)};
    $('nombre-pelicula').val('');
...
//***************************************************************************
// Fin Mostrar película en formulario
//***************************************************************************
...
function peliculaAListado(peliculas) {
    ...
    peliculas.forEach((pelicula) => {
        let { _id, title, releaseYear, nationality, language, platform, mainCharacterName, distributor, genre, producer, actors, url_foto } = pelicula;
...
//***************************************************************************
// Fin Mostrar Listado de películas en la tabla
//***************************************************************************
...
//***************************************************************************
// Fin Seleccionar película de la lista mostrada yrellenar form
//***************************************************************************
...
function leerFormularioPelicula() {
    ...
    input = $('#url-pelicula').val().trim();
    if (input) { result.url_foto = input; $('#url-pelicula').val(input) };    
    return result;
}
//***************************************************************************
// Leer formulario película
